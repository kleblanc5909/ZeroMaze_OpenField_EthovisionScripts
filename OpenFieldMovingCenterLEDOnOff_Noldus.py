...
#    print("after fix: Move start,end", NewMoveStart, NewMoveEnd)
    ...
    return theData, NewMoveStart, NewMoveEnd
...
#    print ("LED off stats: Idx", LEDoffIdx, "filt in center", LEDoff_Filtered_InCenter, "percent time", PercentTimeinCenterLEDoff, "avg vel", AvgVelocityLEDoff)
...
for File in FileList:    
    ...
    if DataBlock['Trial time'].iloc[-1] > NO_BASELINE_10MIN_SESSION_TRIAL_LENGTH:
        DataBlock,startingPoints,endingPoints = Remove_Minute2_LED_OFF(DataBlock,startingPoints,endingPoints) 
#        print ("2 minute LED off period file")
#        print ("IN IF startingPoint first and last Value: ", startingPoints[0], " ", startingPoints[-1])
#        print ("IN IF endingPoint first and last Value: ", endingPoints[0], " ", endingPoints[-1])
#    print ("AFTER IF startingPoint first and last Value: ", startingPoints[0], " ", startingPoints[-1])
#    print ("AFTER IF endingPoint first and last Value: ", endingPoints[0], " ", endingPoints[-1])
