...
resultsColumns = ["Subject", "Drug", "Diet", "Timestamp", "Notes", "Time in Open (%)", \
...
for File in FileList:
    ...
    Dataz = [Sbj,Drg, Grp, DateTime, Note, PerTimeOpen, PerTimeOpenMove,PerTimeClosedMove, \
...
writer = pd.ExcelWriter('DREADD_Zero_Maze_Movement_Analysis4.xlsx')
